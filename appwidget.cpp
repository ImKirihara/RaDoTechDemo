    ...
    currentViewingData(nullptr)
{
    ...
    connect(ui->scanHands, SIGNAL(clicked()), this, SLOT(setCurrentViewingData()));
    connect(ui->scanFeet, SIGNAL(clicked()), this, SLOT(setCurrentViewingData()));
...
bool AppWidget::scanHands(){
    currentViewingData->scanHandsData();
}

bool AppWidget::scanFeet(){
    currentViewingData->scanFeetData();
}
...
void AppWidget::displayData(){
    ...
    if (currentViewingData) {
        if (currentViewingData) {
            ...
            // Assign H1 to H6
            // Assign H1 to H6
            ui->h1Text->setPlainText(QString::number(currentViewingData->get(H1Left)));
            ui->h2Text->setPlainText(QString::number(currentViewingData->get(H2Left)));
            ui->h3Text->setPlainText(QString::number(currentViewingData->get(H3Left)));
            ui->h4Text->setPlainText(QString::number(currentViewingData->get(H4Left)));
            ui->h5Text->setPlainText(QString::number(currentViewingData->get(H5Left)));
            ui->h6Text->setPlainText(QString::number(currentViewingData->get(H6Left)));

            // Assign F1 to F6
            ui->f1Text->setPlainText(QString::number(currentViewingData->get(F1Left)));
            ui->f2Text->setPlainText(QString::number(currentViewingData->get((F2Left))));
            ui->f3Text->setPlainText(QString::number(currentViewingData->get((F3Left))));
            ui->f4Text->setPlainText(QString::number(currentViewingData->get((F4Left))));
            ui->f5Text->setPlainText(QString::number(currentViewingData->get((F5Left))));
            ui->f6Text->setPlainText(QString::number(currentViewingData->get((F6Left))));
