...
""));
        ...
        Homebtn = new QPushButton(groupBox_2);
        Homebtn->setObjectName(QString::fromUtf8("Homebtn"));
        Homebtn->setGeometry(QRect(10, 10, 83, 25));
...
""));
        ...
        enterButton->setGeometry(QRect(120, 310, 141, 61));
        ...
        Homebtn_2->setGeometry(QRect(20, 20, 111, 61));
